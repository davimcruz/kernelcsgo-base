...
// Solicitação para ler memória de usuário virtual (memória de um programa) do espaço do kernel
#define IO_READ_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0701 /*  */, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)

// Solicitação para escrever memória de usuário virtual (memória de um programa) a partir do espaço do kernel
#define IO_WRITE_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0702 /* */, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)

// Solicitação para recuperar o processo de id do csgo, do espaço kernel
#define IO_GET_ID_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0703 /* */, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)

// Solicitação para recuperar o endereço base do cliente.dll no csgo.exe do espaço do kernel
